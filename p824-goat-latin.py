    ...
    def toGoatLatin(self, S):
        ...
        def trans(word):
            if word[0] in "aeiouAEIOU":
                ...
                return word[1:] + word[:1] + "ma"

        return " ".join(trans(w) + "a" * (i + 1) for i, w in enumerate(S.split()))


sol = Solution().toGoatLatin
print(sol("I speak Goat Latin"))
print(sol("The quick brown fox jumped over the lazy dog"))
